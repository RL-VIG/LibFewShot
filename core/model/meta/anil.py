...
class ANIL_Layer(nn.Module):
    def __init__(self, feat_dim, hid_dim, train_way):
...
class ANIL(MetaModel):
    def __init__(self, train_way, train_shot, train_query, emb_func, device, inner_para, feat_dim, hid_dim):
        super(ANIL, self).__init__(train_way, train_shot, train_query, emb_func, device)
        self.feat_dim = feat_dim
        self.loss_func = nn.CrossEntropyLoss()
        self.classifier = ANIL_Layer(feat_dim=feat_dim, hid_dim=hid_dim, train_way=train_way)
