...
model_trained = './results/PreTrain_based_FSL/Baseline_ResNet12_RFS_Epoch_100_miniImageNet_84_84_5Way_1Shot'
...
def test(test_loader, model, criterion, epoch_index, F_txt):
	...
	print(' * Prec@1 {top1.avg:.3f} '.format(top1=top1), file=F_txt)
